...
/* -----------------------------------------------------------------------------
 ...
 File: es.tid.corba.TIDNamingAdminClient.GetSpaces.java
...
public class GetSpaces {
    ...
    if((args.length > 0) && args[0].equals("-help")){
      System.err.println("Print the NamingSpaces information");
      System.err.println("\tin: reads the Agent IOR");
      System.err.println("\tout: the NamingSpaces information");      
      System.err.println("Usage: get_spaces [-help]");
      return;
    }
    ...
    NamingSpace[] spaces = naming_agent.get_spaces();
    
    if(spaces.length == 0)
        System.out.println("get_spaces: No space in server");
    
    for (int i = 0; i < spaces.length; i++)
        System.out.println(TIDNamingAdminHandler.toString(spaces[i], orb));
