...
/* -----------------------------------------------------------------------------
 ...
 File: es.tid.corba.TIDNamingAdminClient.ShutdownService.java
...
public class ShutdownService {
    ...
    if((args.length > 1) && args[0].equals("-help")){
      System.err.println("shutdown_service: Shutdowns the TIDNaming Service");
      System.err.println("\tin: reads the Agent IOR");
      System.err.println("Usage: shutdown_service [-help]");
      return;
    }
    ...
    try {
        ...
        naming_agent.shutdown_service();
        
        System.out.println("shutdown_service: OK!");
