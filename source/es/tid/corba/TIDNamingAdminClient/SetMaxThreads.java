...
/* -----------------------------------------------------------------------------
 ...
 File: es.tid.corba.TIDNamingAdminClient.GetSpace.java
...
/**
 * set_max_threads command. 
 * <p> Copyright 2001 Telef&oacute;nica I+D. Printed in Spain (Europe). All Rights Reserved.
 * @autor Juan A. C&aacute;ceres
 * @version 1.0
 */

public class SetMaxThreads {
	
    public static void main(String args[])
    {
    
    if((args.length == 0) || (args[0].equals("-help"))){
      System.err.println("Print the NamingSpace information");
      System.err.println("\tin: reads the Agent IOR");
      System.err.println("\tout: NamingSpace information");      
      System.err.println("Usage: set_max_threads (space_name thread_number) | -help");
      return;
    }
    
    if(args.length < 2) {
      System.err.println("set_max_threads: Bad param number");
      System.err.println("Usage: set_max_threads (space_name thread_number) | -help");
      return;
    }
    ...
    try {
        ...
        */
        ...
        System.err.println("set_max_threads: Error reading IOR from Standard Input");
    ...
    try {
        ...
        naming_agent.set_max_threads(args[0], Integer.parseInt(args[1])); 
        
    } catch (NamingSpaceNotExist ne) {
        System.err.println("set_max_threads: NamingSpace " + args[0] + " does not exist.");
    } catch (Exception e) {
        e.printStackTrace();  
    }
