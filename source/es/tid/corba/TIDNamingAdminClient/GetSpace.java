...
public class GetSpace {
    ...
    if(args.length < 1) {
      System.err.println("get_space: Bad param number");
      System.err.println("Usage: get_space space_name | -help");
      return;
    }
    ...
    try
        ...
        System.err.println("get_space: Error reading IOR from Standard Input");
    ...
    try {
      ...
      NamingSpace space = naming_agent.get_space(args[0]);   
      
      System.out.println(TIDNamingAdminHandler.toString(space, orb));
      
    } catch (NamingSpaceNotExist ne) {
      System.err.println("get_space: NamingSpace " + args[0] + " does not exist.");
    } catch (Exception e) {
      e.printStackTrace();  
    }
