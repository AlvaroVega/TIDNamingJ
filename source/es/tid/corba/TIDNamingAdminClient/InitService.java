...
/* -----------------------------------------------------------------------------
 ...
 File: es.tid.corba.TIDNamingAdminClient.InitService.java
...
public class InitService {
    ...
    if((args.length > 1) && args[0].equals("-help")){
      System.err.println("Initialize the TIDNaming Service");
      System.err.println("\tin: reads the Agent IOR");
      System.err.println("Usage: init_service [-help]");
      return;
    }
    ...
    try {
        ...
        naming_agent.init_service();
        
        System.out.println("init_space: OK!");
        
    } catch (CannotProceed cp) {
        System.err.println("init_space: Error initializing service: " + cp.why);
    } catch (Exception e) {
        e.printStackTrace();	
    }
