...
/* -----------------------------------------------------------------------------
 ...
 File: es.tid.corba.TIDNamingAdminClient.GetRootContext.java
...
public class GetRootContext {
    ...
    public static void main(String args[]) {
        if(args.length < 1) {
            System.err.println("get_root_context: Bad param number");
            System.err.println("Usage: get_root_context space_name | -help");
            return;
        }
        ...
        try {
            ...
            */
            ...
            System.err.println("get_root_context: Error reading IOR from Standard Input");
        ...
        try {
            ...
            NamingContext rootContext = naming_agent.get_root_context(args[0]);
            
            System.out.println(orb.object_to_string(rootContext));
            
        } catch (NamingSpaceNotExist ne) {
            System.err.println("get_root_context: NamingSpace " + args[0] + " does not exist.");
        } catch (Exception e) {
            e.printStackTrace();	
        }
