...
/*
 ...
 File: es.tid.corba.TIDNaming.nulldb.NullRowIterator.java
...
public class NullRowIterator implements es.tid.corba.TIDNaming.RowIterator {
    ...
    public NullRowIterator(Trace trace) 
    {
        this.trace = trace;
