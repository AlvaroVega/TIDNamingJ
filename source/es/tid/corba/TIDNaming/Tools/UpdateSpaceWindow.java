...
public class UpdateSpaceWindow extends JFrame {

    String spacename;
    Agent agent;
    NamingSpaceAccessData data = new NamingSpaceAccessData();
    JLabel jl1 = new JLabel("Name Space to update: ");
    ...
    public UpdateSpaceWindow(String spacename, Agent agent) 
    {
	...
	Dimension d = tk.getScreenSize();
        ...
        this.setTitle("Update Space Window");
	...
	jtf_namespace.setText(spacename);
	...
	SQL_AccessData  sql_access;
        ...
        try {
            ...
            if (String.valueOf(jpf1.getPassword()).equals(String.valueOf(jpf2.getPassword()))) {
                ...
                agent.update_space(spacename, data);
                this.hide();
                this.dispose();
            }
            else
            ...
            JOptionPane.showMessageDialog(null,"InvalidAccesData Exception has been raised",
                                          "corba error",JOptionPane.ERROR_MESSAGE);
