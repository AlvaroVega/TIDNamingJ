...
public class BindContextWindow extends JFrame {
  ...
  public BindContextWindow (NamingContext context, org.omg.CORBA.ORB orb)
  {
      ...
      this.setTitle("BindContext Window");
  ...
  private void acceptBindContext() 
  {
    ...
    try {     
        ...
        name = TreatName.to_name(aux);
      	context.bind_context(name,NamingContextHelper.narrow(orb.string_to_object(jta1.getText())));
      	this.hide();
      	this.dispose();
        ...
        JOptionPane.showMessageDialog(null,"InvaledName Exception has been raised","corba error",JOptionPane.ERROR_MESSAGE);	
  ...
  private void cancelBindContext() 
  {
    this.hide();
    this.dispose();
  } //cancelBindContext
