...
public class RemoveSpaceWindow extends JFrame {

    String spacename;
    Agent agent;
    JLabel jl1 = new JLabel("Remove Space:");
    JTextField jtfEspacioActivo = new JTextField();
    JButton jbaccept = new JButton("Accept");
    JButton jbcancel = new JButton("Cancel");
	
    public RemoveSpaceWindow (String spacename, Agent agent) 
    {
	...
	Toolkit tk = Toolkit.getDefaultToolkit();
        ...
        this.setTitle("Remove Space Window");
    ...
    private void acceptRemove () 
    {
        ...
        try 
            {
                agent.remove_space (spacename);
                this.hide();
                this.dispose();
            }
        catch (es.tid.corba.TIDNamingAdmin.AgentPackage.NamingSpaceNotExist ex1)
            {
		JOptionPane.showMessageDialog(null,"NamingSpaceNotExist Exception has been raised","corba error",JOptionPane.ERROR_MESSAGE);
            }
