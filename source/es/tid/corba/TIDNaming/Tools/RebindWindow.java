...
public class RebindWindow extends JFrame {
    ...
    public RebindWindow (NamingContext context,NameComponent[] name, org.omg.CORBA.ORB orb)
    {
    ...
    private void acceptRebind() 
    {	
        try 
            {     
                context.rebind(name,orb.string_to_object(jta1.getText()));
                this.hide();
                this.dispose();
            }
