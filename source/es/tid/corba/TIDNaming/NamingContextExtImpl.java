...
/**
 * Implementation class of CosNaming::NamingContextExt. <p>
...
public class NamingContextExtImpl extends NamingContextExtPOA
{
     ...
     * Constructor.
     */
    public NamingContextExtImpl(org.omg.CORBA.ORB orb, 
    ...
    public org.omg.CORBA.Object resolve(org.omg.CosNaming.NameComponent[] n)
        ...
        if (my_trace != null) {
            my_trace.print(Trace.USER,"NamingContextExtImpl::resolve ");
        }
    ...
    public void bind(org.omg.CosNaming.NameComponent[] n, org.omg.CORBA.Object obj)
        ...
        if (my_trace != null) {
            my_trace.print(Trace.USER,"NamingContextExtImpl::bind ");
        }
        ...
        try {
            ...
            if(n.length == 1) {
                ...
                if (my_trace != null) {
                    String[] msg = {"NamingContextExtImpl::bind name_id=", 
            ...
            if (my_trace != null) {
                if(oid_str != null) {
                    String[] msg = 
                        {"NamingSpaceServer::bind in  ",oid_str, " error: ",th.toString()}; 
                    my_trace.print(Trace.ERROR,msg);
                } else {
                    String[] msg = 
                        {"NamingSpaceServer::bind error: ",th.toString()}; 
                    my_trace.print(Trace.ERROR,msg);
                }         
            }       
            throw new CannotProceed(my_reference(oid), n);
    ...
    public void rebind(org.omg.CosNaming.NameComponent[] n, org.omg.CORBA.Object obj)
        ...
        if (my_trace != null) {
            my_trace.print(Trace.USER,"NamingContextExtImpl::rebind ");
        }
        NamingContext next_context = null;
        // validate NameComponent[] names
        NameComponent[] next_name = getNextName(n);
        ...
        try {
            ...
            if(n.length == 1) { 
                ...
                if (my_trace != null) {
                    String[] msg = {"NamingContextExtImpl::rebind name_id=", 
            ...
            if (my_trace != null) {
                if(oid_str != null) {
                    String[] msg = 
                        {"NamingSpaceServer::rebind in  ",oid_str, " error: ",th.toString()}; 
                    my_trace.print(Trace.ERROR,msg);
                } else {
                    String[] msg = 
                        {"NamingSpaceServer::rebind error: ",th.toString()}; 
                    my_trace.print(Trace.ERROR,msg);
                }             
            }
            throw new CannotProceed(my_reference(oid), n);
    ...
    public void unbind(org.omg.CosNaming.NameComponent[] n)
        ...
        if (my_trace != null) {
            my_trace.print(Trace.USER,"NamingContextExtImpl::unbind ");
        }
        NamingContext next_context = null;
        // validate NameComponent[] names
        NameComponent[] next_name = getNextName(n);
        ...
        try {
            ...
            if(n.length == 1) { 
                ...
                if (my_trace != null) {
                    String[] msg = {"NamingContextExtImpl::unbind name_id=", 
            ...
            if (my_trace != null) {
                if(oid_str != null) {
                    String[] msg = 
                        {"NamingSpaceServer::unbind in  ",oid_str, " error: ",th.toString()}; 
                    my_trace.print(Trace.ERROR,msg);
                } else {
                    String[] msg = 
                        {"NamingSpaceServer::unbind error: ",th.toString()}; 
                    my_trace.print(Trace.ERROR,msg);
                }             
            }
            throw new CannotProceed(my_reference(oid), n);
    ...
    public org.omg.CosNaming.NamingContext new_context(){
            ...
            if (my_trace != null) {
                my_trace.print(Trace.USER,"NamingContextExtImpl::new_context ");
            }
            ...
            try {
                ...
                if (my_trace != null) {
                    if(oid_str != null) {
                        String[] msg = 
                            {"NamingSpaceServer::new_context in ",oid_str, " error: ",th.toString()}; 
                        my_trace.print(Trace.ERROR,msg);
                    } else {
                        String[] msg = 
                            {"NamingSpaceServer::new error: ",th.toString()}; 
                        my_trace.print(Trace.ERROR,msg);
                    }             
                }
    ...
    public org.omg.CosNaming.NamingContext global_new_context(){
        ...
        if (my_trace != null) {
            my_trace.print(Trace.USER,"NamingContextExtImpl::global_new_context ");
        }
        ...
        try {
            ...
            if (my_trace != null) {
                String[] msg = {"NamingContextExtImpl::global_new_context ", oid_str," created"}; 
                my_trace.print(Trace.DEBUG,msg);
            }
            ...
            if (my_trace != null) {
                if(oid_str != null) {
                    String[] msg = 
                        {"NamingSpaceServer::global_new_context in  ",oid_str, " error: ",th.toString()}; 
                    my_trace.print(Trace.ERROR,msg);
                } else {
                    String[] msg = 
                        {"NamingSpaceServer::global_new_context error: ",th.toString()}; 
                    my_trace.print(Trace.ERROR,msg);
                }             
            }  
            return null;
    ...
    public void bind_context(NameComponent[] n, NamingContext nc)
        ...
        if (my_trace != null) {
            my_trace.print(Trace.USER,"NamingContextExtImpl::bind_context ");
        }
        ...
        try {
            ...
            if (my_trace != null) {
                if(oid_str != null) {
                    String[] msg = 
                        {"NamingSpaceServer::bind_context in  ",oid_str, " error: ",th.toString()}; 
                    my_trace.print(Trace.ERROR,msg);
                } else {
                    String[] msg = 
                        {"NamingSpaceServer::bind_context error: ",th.toString()}; 
                    my_trace.print(Trace.ERROR,msg);
                }             
            }  
            throw new CannotProceed(my_reference(oid), n);
    ...
    public void rebind_context(NameComponent[] n, NamingContext nc)
        ...
        if (my_trace != null) {
            my_trace.print(Trace.USER,"NamingContextExtImpl::rebind_context ");
        }
        ...
        try {
            ...
            if (my_trace != null) {
                if(oid_str != null) {
                    String[] msg = 
                        {"NamingSpaceServer::rebind_context in  ",oid_str, " error: ",th.toString()}; 
                    my_trace.print(Trace.ERROR,msg);
                } else {
                    String[] msg = 
                        {"NamingSpaceServer::rebind_context error: ",th.toString()}; 
                    my_trace.print(Trace.ERROR,msg);
                }             
            }
            throw new CannotProceed(my_reference(oid), n);
    ...
    public NamingContext bind_new_context(NameComponent[] n)
        ...
        try {
            ...
            if (my_trace != null) {
                if(oid_str != null) {
                    String[] msg = 
                        {"NamingSpaceServer::bind_new_context in ",oid_str, 
                         " error: ",th.toString()}; 
                    my_trace.print(Trace.ERROR,msg);
                } else {
                    String[] msg = 
                        {"NamingSpaceServer::bind_newcontext error: ",th.toString()}; 
                    my_trace.print(Trace.ERROR,msg);
                }             
            }
            throw new org.omg.CORBA.TRANSIENT();
    ...
    public void destroy() throws NotEmpty{
        ...
        if (my_trace != null) {
            my_trace.print(Trace.USER,"NamingContextExtImpl::destroy ");
        }
        ...
        try {
            ...
            if (my_trace != null) {
                if(oid_str != null) {
                    String[] msg = 
                        {"NamingSpaceServer::destroy in  ",oid_str, " error: ",th.toString()}; 
                    my_trace.print(Trace.ERROR,msg);
                } else {
                    String[] msg = 
                        {"NamingSpaceServer::destroy error: ",th.toString()}; 
                    my_trace.print(Trace.ERROR,msg);
                }             
            }
        }  
    ...
    public void list(int how_many, BindingListHolder bl, BindingIteratorHolder bi){
        ...
        if (my_trace != null) {
            my_trace.print(Trace.USER,"NamingContextExtImpl::list ");
        }
        ...
        try { 
            ...
            if (my_trace != null) {
                if(oid_str != null) {
                    String[] msg = 
                        {"NamingSpaceServer::list in  ",oid_str, " error: ",th.toString()}; 
                    my_trace.print(Trace.ERROR,msg);
                } else {
                    String[] msg = 
                        {"NamingSpaceServer::list error: ",th.toString()}; 
                    my_trace.print(Trace.ERROR,msg);
                }             
            }
        }  
    ...
    private NamingContext my_reference(byte[] my_oid) {
        ...
        try {
            return NamingContextHelper.narrow(
                      my_poa.create_reference_with_id(my_oid, NamingContextExtHelper.id()));
        } catch(Exception ex) {
            return null;
        }
    ...
    {
        if (my_trace != null) {
            my_trace.print(Trace.USER,"NamingContextExtImpl::to_string ");
        }
  	return Corbaname.toString(n);
    }
    ...
    {
        if (my_trace != null) {
            my_trace.print(Trace.USER,"NamingContextExtImpl::to_name ");
        }
 	return Corbaname.toName(sn);
    }
    ...
    {
        if (my_trace != null) {
            my_trace.print(Trace.USER,"NamingContextExtImpl::to_url ");
        }
 	org.omg.CosNaming.NameComponent[] n = Corbaname.toName(sn);
	if (addr.equals("")) 
            throw new InvalidAddress();
	else
            return "corbaname:"+TranslateURLEscapes.translateEscapes(addr)+
                "#"+TranslateURLEscapes.translateEscapes(sn);
		
    }

  
    //TODO: rojas: removed alreadybound exception since spec doen's says so
    public org.omg.CORBA.Object resolve_str(java.lang.String sn)
        throws 	org.omg.CosNaming.NamingContextPackage.NotFound,
                org.omg.CosNaming.NamingContextPackage.CannotProceed,
                org.omg.CosNaming.NamingContextPackage.InvalidName {
 	return resolve(Corbaname.toName(sn));
    }
 
    public org.omg.CosNaming.NamingContext resolve_context(org.omg.CosNaming.NameComponent[] n)
        throws 	org.omg.CosNaming.NamingContextPackage.NotFound,
                org.omg.CosNaming.NamingContextPackage.CannotProceed,
                org.omg.CosNaming.NamingContextPackage.InvalidName{
        ...
        NamingContextExt next_context = null;
        NameComponent[] next_name = getNextName(n);
        String oid_str = null;
        byte[] oid = null;
        ...
        try {
            ...
            // Path Binding
            String next_context_str = my_db.resolve_context(oid_str, n[0].id, n[0].kind);
            next_context = NamingContextExtHelper.narrow(my_orb.string_to_object(next_context_str));
        ...
        try{
            return ((NamingContextExtImpl)next_context).resolve_context(next_name);
        }catch (org.omg.CORBA.OBJECT_NOT_EXIST no) {
            throw new NotFound(NotFoundReason.not_object,next_name);
        } catch (org.omg.CORBA.SystemException se) {
            throw new CannotProceed(next_context, next_name);
