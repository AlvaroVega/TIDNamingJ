//
// InitSequenceHelper.java (helper)
//
...
abstract public class InitSequenceHelper {
  ...
  public static org.omg.CORBA.TypeCode type() {
    if (_type == null) {
      ...
      _type = _orb().create_alias_tc(id(), "InitSequence", original_type);
    }
    return _type;
  };

  public static String id() {
    return "IDL:tid.es/TIDNamingAdmin/InitSequence:1.0";
  };
