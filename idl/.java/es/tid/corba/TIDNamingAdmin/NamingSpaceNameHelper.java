//
// NamingSpaceNameHelper.java (helper)
//
...
abstract public class NamingSpaceNameHelper {
  ...
  public static org.omg.CORBA.TypeCode type() {
    if (_type == null) {
      ...
      _type = _orb().create_alias_tc(id(), "NamingSpaceName", original_type);
    }
    return _type;
  };

  public static String id() {
    return "IDL:tid.es/TIDNamingAdmin/NamingSpaceName:1.0";
  };
