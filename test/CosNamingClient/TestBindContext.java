...
public class TestBindContext {
                             ...
                             String id, boolean print)
  {
    if(print) {
      System.err.print('(');
      System.err.print(id);
      System.err.print(") TestBindContext ");
      NMUtil.print(name);
      System.err.print('\n');
    }
    ...
    try {
      ...
      context.bind_context(name,new_context);
      ...
      if((expected_exception != null) && 
        ...
        if(print) {
          System.err.print("\t(");
          System.err.print(id);
          System.err.print(") TestBindContext: Expected Exception ");
          NMUtil.print(nf);
          System.err.print('\n');
        }
       ...
       if(print) {
          System.err.print("\t(");
          System.err.print(id);
          System.err.print(") TestBindContext: ERROR, unexpected Exception ");
          NMUtil.print(nf);
          System.err.print('\n');
       }
        return false;
