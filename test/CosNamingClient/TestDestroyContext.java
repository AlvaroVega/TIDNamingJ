...
public class TestDestroyContext {
                             ...
                             String id, boolean print)
  {
    if(print) {
      System.err.print('(');
      System.err.print(id);
      System.err.println(") TestDestroyContext: destroy()");
    }
    ...
    try {
      ...
      if((expected_exception != null) && expected_exception.isInstance(e))
      {
        if(print) {
          System.err.print("\t(");
          System.err.print(id);
          System.err.print(") TestDestroyContext: Expected Exception ");        
          System.err.println(e.toString());
        }
        System.err.println("TestDestroyContext: OK!!");        
        return true;
      } else {
        if(print) {
          System.err.print("\t(");
          System.err.print(id);
          System.err.print(") TestDestroyContext: ERROR, unexpected exception ");
          System.err.println(e.toString());
        }
        
        System.err.println("TestDestroyContext: ERROR!!");        
        return false;
      }
    }
    System.err.println("TestDestroyContext: OK!!");        
