...
public class TestBindNewContext {
                             ...
                             String id, boolean print)
  {
    if(print) {
      System.err.print('(');
      System.err.print(id);
      System.err.print(") TestBindNewContext ");
      NMUtil.print(name);
      System.err.print('\n');
    }
    ...
    try {
      ...
      holder.value = context.bind_new_context(name);
      ...
      if((expected_exception != null) && 
        ...
        if(print) {
          System.err.print("\t(");
          System.err.print(id);
          System.err.println(") TestBindNewContext: Expected Exception ");
          NMUtil.print(nf);
        }
       ...
       if(print) {
          System.err.print("\t(");
          System.err.print(id);
          System.err.println(") TestBindNewContext: ERROR, unexpected Exception ");
          NMUtil.print(nf);
       }
        return false;
      }
    ...
    if(print) {
      System.err.print("\t(");
      System.err.print(id);
      System.err.println(") TestBindNewContext: OK!");
    }
